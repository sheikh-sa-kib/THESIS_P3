...
def print_report() -> int:
    ...
    if failures == 0:
        ...
        print("  " + "=" * 62)
        print()
        print(f"  Estimated runtime (heavy preset):  {runtime_est}")
        print()
        print("  Presets:")
        print()
        print("    smoke   — Installation verification (1 algo, 30 steps, 10 veh, ~10s)")
        print("    light   — Quick comparison (all 6 algos, 100 steps, 50 veh, ~5-15 min)")
        print("    heavy   — Thesis-quality experiment (all 6 algos, 300 steps, 300 veh, emergencies,")
        print("              benchmarks, automated plots, full summary)  [RECOMMENDED]")
        print("    extreme — Stress-test (all 6 algos, 600 steps, 500 veh, 5 emergencies, ~2-6 hr)")
        print()
        print("  Copy and paste:")
        print()
        print(f'    python run_thesis.py --preset smoke')
        print(f'    python run_thesis.py --preset light')
        print(f'    python run_thesis.py --preset heavy')
        print(f'    python run_thesis.py --preset extreme')
        print(f'    python run_thesis.py --preset heavy --seeds 42 43 44')
        print()
        return 0
